...
class TransModel extends Model
{
     ...
     */
    public function getTransByWhere($where, $offset, $limit)
    {
        return $this
            ->where($where)
            ->limit($offset, $limit)
     ...
     * @return int|string
     */
    public function getAllTransCount($where)
    {
     ...
     * @throws \think\exception\DbException
     */
    public function getAllTrans($where)
    {
     ...
     * @return array
     */
    public function insertTrans($param)
    {
        try{
     ...
     * @throws \think\exception\DbException
     */
    public function getOneTrans($id)
    {
